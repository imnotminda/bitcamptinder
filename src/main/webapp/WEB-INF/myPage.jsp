		...
		<div style="display: flex;">
			...
			<div class="profile-widget">
				...
				<div class="user-details">
					...
					<div class="followers">
						<h3>
							아이디<br> <span>${sessionScope.userDTO.user_username}</span>
						</h3>
						<h3>
							나이<br> <span>${sessionScope.userDTO.user_useage}</span>
						</h3>
						<h3>
							mbti<br> <span>${sessionScope.userDTO.user_mbti}</span>
						</h3>
						<h3>
							영화<br> <span>${sessionScope.userDTO.user_mbti}</span>
						</h3>
						<h3>
							종교<br> <span>${sessionScope.countSum}</span>
						</h3>
						<h3>
							여행<br> <span>${sessionScope.countSum}</span>
						</h3>
					</div>
